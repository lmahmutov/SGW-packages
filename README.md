...
This is the OpenWrt 21.02.0 "packages"-feed containing community-maintained build scripts, options and patches for applications, modules and libraries used within OpenWrt.
...
Homeassistan Core and Domoticz updated to latest versions
